package lenovo1.core.generated
...
import lenovo1.core.api
import lenovo1.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = lenovo1.core.api as Api<T>
    override val config: ApplicationConfig = lenovo1.core.config
}
